...
datadir = 'U:/RAW DATA/Cuffed Mice/1mois'

#Where to save the data 
savedir = 'U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/001_FOR_PAPER/INDIVIDUAL_MAPS/Early_Cuff'
...
df  = pd.read_excel('U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/001_FOR_PAPER/Mesures_ZII_HighRes_WT_Cuff_Sham_Enr.xlsx',
                    sheet_name='Early_Cuff',index_col=0,header=1)  #DataFrame containing zebrin band file 
...
filelist  = pd.read_excel('U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/001_FOR_PAPER/GC-PC_mappings_data_info.xlsx',
                          sheet_name='Early_Cuff',index_col=0,header=0)  #DataFrame containing zebrin band file 
