# -*- coding: utf-8 -*-
"""
Created on Mon Jan 13 10:54:02 2020
...
NAMES = ['Sham_020617(1)',
         'Sham_030617(1)','Sham_030617(2)','Sham_030617(3)',
         'Sham_040617(1)','Sham_040617(2)',
         'Sham_050617(1)','Sham_050617(2)','Sham_050617(3)',
         'Sham_111219(1)','Sham_111219(2)','Sham_111219(3)',
         'Sham_121219(1)','Sham_121219(2)']

FOLDERS = ['Sham_02-06-2017',
           'Sham_03-06-2017','Sham_03-06-2017','Sham_03-06-2017',
           'Sham_04-06-2017','Sham_04-06-2017',
           'Sham_05-06-2017','Sham_05-06-2017','Sham_05-06-2017',
           '11122019','11122019','11122019',
           '12112019','12112019']


#Where are the data ? The data are in the kitchen :) 
datadir = 'U:/RAW DATA/Sham Mice/Early'

#Where to save the data 
savedir = 'U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/001_FOR_PAPER/INDIVIDUAL_MAPS/Early_Sham'

#Excel sheet with zebrin band measures : Mesures_ZII_HighRes_WT_Cuff_Sham_Enr.xlsx
df  = pd.read_excel('U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/001_FOR_PAPER/Mesures_ZII_HighRes_WT_Cuff_Sham_Enr.xlsx',
                    sheet_name='Early_Sham',index_col=0,header=1)  #DataFrame containing zebrin band file 

#Excel sheet with files and parameters : GC-PC_mappings_data_info.xlsx  
filelist  = pd.read_excel('U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/001_FOR_PAPER/GC-PC_mappings_data_info.xlsx',
                          sheet_name='Early_Sham',index_col=0,header=0)  #DataFrame containing zebrin band file 
...
for NAME,FOLDER,IDX in zip(NAMES,FOLDERS,range(len(NAMES))):
    ...
    try : 
        ...
        n,bins,patches, = plt.hist(reverse_noise, 100,density=1,facecolor='gray',alpha=0.5, label='noise distrubution') #Histogram
