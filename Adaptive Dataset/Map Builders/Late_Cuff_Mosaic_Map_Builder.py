...
#         '060318-D1(1)',
#         '070318-B4(1)','070318-B4(2)',
#         '080318-B1(1)','080318-B1(2)',
#         '090318-B2(1)',
#         '100318-B3(1)',
#         '110318-A3(1)','110318-A3(2)',
#         '190318-A2(1)',
#         '270218-D3(1)','270218-D3(2)',
#         '280218-D4(1)','280218-D4(2)']
#
#FOLDERS = ['05-03-2018-D2','05-03-2018-D2','05-03-2018-D2',
#           '06-03-2018-D1',
#           '07-03-2018-B4','07-03-2018-B4',
#           '08-03-2018-B1','08-03-2018-B1',
#           '09-03-2018-B2',
#           '10-03-2018-B3',
#           '11-03-2018-A3','11-03-2018-A3',
#           '19-03-2018-A2',
#           '27-02-2018-D3','27-02-2018-D3',
#           '28-02-2018-D4']

NAMES = ['080318-B1(2)',
         '090318-B2(1)']

FOLDERS = ['08-03-2018-B1',
           '09-03-2018-B2']

#Where are the data ? The data are in the kitchen :) 
datadir = 'D:/RAW_DATA/MAPPINGS/LC'

#Where to save the data 
savedir = 'D:/000_PAPER/Amplitude_Analysis/Sigma/LC'
...
df  = pd.read_excel('D:/000_PAPER/Mesures_ZII_HighRes_WT_Cuff_Sham_Enr.xlsx',
                    sheet_name='Late_Cuff',index_col=0,header=1)  #DataFrame containing zebrin band file 
...
filelist  = pd.read_excel('D:/000_PAPER/GC-PC_mappings_data_info.xlsx',
                          sheet_name='Late_Cuff',index_col=0,header=0)  #DataFrame containing zebrin band file 
...
FAST = True #If True, will NOT plot/save current plots to increase speed 
