...
#
NAMES = ['200318-A1(1)',
         '220318-C1(1)','220318-C1(2)',
         '010318-C2(2)','010318-C2(1)',
         '230318-C3(1)','230318-C3(2)',
         '210318-C4(1)','210318-C4(2)',
         '260218-D5(2)','260218-D5(3)',
         '231219-S0(1)','231219-S0(2)','231219-S0(3)',
         '241219-S4(1)','241219-S4(2)',
         '271219-S3(1)',
         '281219-S1(1)','281219-S1(2)','281219-S1(3)']

FOLDERS = ['20-03-2018-A1',
           '22-03-2018-C1','22-03-2018-C1',
           '01-03-2018-C2','01-03-2018-C2',
           '23-03-2018-C3','23-03-2018-C3',
           '21-03-2018-C4','21-03-2018-C4',
           '26-02-2018-D5','26-02-2018-D5',
           '23122019(S0)','23122019(S0)','23122019(S0)',
           '24122019(S4)','24122019(S4)',
           '27122019(S3)',
           '28122019(S1)','28122019(S1)','28122019(S1)']
...
datadir = 'D:/RAW_DATA/Mapping Post Doc/SHAM'

#Where to save the data 
savedir = 'U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/001_FOR_PAPER/INDIVIDUAL_MAPS/Late_Sham'

#Excel sheet with zebrin band measures : Mesures_ZII_HighRes_WT_Cuff_Sham_Enr.xlsx
df  = pd.read_excel('D:/000_PAPER/Mesures_ZII_HighRes_WT_Cuff_Sham_Enr.xlsx',
                    sheet_name='Late_Sham',index_col=0,header=1)  #DataFrame containing zebrin band file 

#Excel sheet with files and parameters : GC-PC_mappings_data_info.xlsx  
filelist  = pd.read_excel('D:/000_PAPER/GC-PC_mappings_data_info.xlsx',
                          sheet_name='Late_Sham',index_col=0,header=0)  #DataFrame containing zebrin band file 

#Number of bins for noise fitting, 100 if map is complete, 50 for security
number_bin_fit = 50

SAVING = False #If True, saves the data in savedir
...
for NAME,FOLDER,IDX in zip(NAMES,FOLDERS,range(len(NAMES))):
    ...
    try : 
        ...
        reverse_noise = np.asarray([item*-1 for item in noise if item<=0])
