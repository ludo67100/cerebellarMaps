...
#NAMES = ['ENR_270820(1)','ENR_270820(2)',
#         'ENR_280820(1)',
#         'ENR_090920(1)','ENR_090920(2)',
#         'ENR_100920(1)']
#
#FOLDERS = ['27082020(0)','27082020(0)',
#           '28082020(4)',
...
datadir = 'U:/RAW DATA/Enrichissement'

#Where to save the data 
savedir = 'E:/000_PAPER/Amplitude_Analysis/Sigma/00_MAPS/newENR'
...
filelist  = pd.read_excel('E:/000_PAPER/GC-PC_mappings_data_info.xlsx',
                          sheet_name='ENR',index_col=0,header=0)  #DataFrame containing zebrin band file 
