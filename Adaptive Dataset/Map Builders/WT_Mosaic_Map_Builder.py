...
FOLDERS = ['AD-07-06-2016','AD-07-06-2016',
           'AD-08-06-2016','AD-08-06-2016',
           'AD-09-06-2016','AD-09-06-2016',
           'AD-14-04-2016','AD-14-04-2016',
           'AD-16-11-2016',
           'AD-17-11-2016',
           'AD-18-11-2016','AD-18-11-2016',
           'AD-25-05-2016',
           'AD-31-05-2016']


#Where are the data ? The data are in the kitchen :) 
datadir = 'U:/RAW DATA/Mapping PHD'

#Where to save the data 
savedir = 'U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/001_FOR_PAPER/INDIVIDUAL_MAPS/WT'
...
df  = pd.read_excel('E:/000_PAPER/Mesures_ZII_HighRes_WT_ENR_EC_LC_ES_LS.xlsx',
                    sheet_name='WT',index_col=0,header=1)  #DataFrame containing zebrin band file 
...
filelist  = pd.read_excel('E:/000_PAPER/GC-PC_mappings_data_info.xlsx',
                          sheet_name='WT',index_col=0,header=0)  #DataFrame containing zebrin band file 
...
for NAME,FOLDER,IDX in zip(NAMES,FOLDERS,range(len(NAMES))):
    ...
    try : 
        ...
        v = ax[4].imshow(np.abs(_FULL_SIGNAL_MAP),interpolation='nearest', cmap='magma',vmin = np.abs(root_x))
        cbar1 = plt.colorbar(v,orientation='horizontal')
        ax[4].set_title('2D Max Amplitude',loc='right')
        
        mask = Zscore_2D>=ZSOCRE_CUT				#2D Zscore
        ax[3].imshow(mask, interpolation='none',cmap='magma')
