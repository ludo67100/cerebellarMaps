...
UPDATE 06/05/2019 : This version runs with neo 
...
NAMES = ['070717(1)',
         ...
         '161016(1)','161016(2)',
         '171016(1)','171016(2)',
         '181016(1)','181016(2)','181016(3)',
         '191016(1)','191016(2)',
         '201016(1)','201016(3)',
         '211016(1)','211016(2)']

FOLDERS = ['Cuff_070717(1)',
          'Cuff_080617(1)',
          'Cuff_080717(1)',
          'Cuff_090717(1)',
          'Cuff_110717(1)','Cuff_110717(2)',
          'Cuff_120717(1)','Cuff_120717(2)',
          'Cuff_130717(1)','Cuff_130717(2)',
          'Cuff_141016(1)','Cuff_141016(2)',
          'Cuff_161016(1)','Cuff_161016(2)',
          'Cuff_171016(1)','Cuff_171016(2)',
          'Cuff_181016(1)','Cuff_181016(2)','Cuff_181016(3)',
          'Cuff_191016(1)','Cuff_191016(2)',
          'Cuff_201016(1)','Cuff_201016(3)',
          'Cuff_211016(1)','Cuff_211016(2)']
...
df  = pd.read_excel(measureFile,
                    sheet_name='EC',index_col=0,header=1)  #DataFrame containing zebrin band file 

#Excel sheet with files and parameters : GC-PC_mappings_data_info.xlsx  
filelist  = pd.read_excel(infoFile,
                          sheet_name='early_cuff (EC)',index_col=0,header=0)  #DataFrame containing zebrin band file 
...
for NAME,FOLDER,IDX in zip(NAMES,FOLDERS,range(len(NAMES))):
    ...
    try : 
        ...
        n,bins,patches, = plt.hist(reverse_noise, 30,density=1,facecolor='gray',alpha=0.5, label='noise distrubution') #Histogram
