...
NAMES = ['Sham_020617(1)',
         'Sham_030617(2)','Sham_030617(3)',
         'Sham_040617(2)',
         'Sham_050617(1)','Sham_050617(2)','Sham_050617(3)',
         'Sham_111219(2)','Sham_111219(3)',
...
df  = pd.read_excel(measureFile,
                    sheet_name='ES',index_col=0,header=1)  #DataFrame containing zebrin band file 

#Excel sheet with files and parameters : GC-PC_mappings_data_info.xlsx  
filelist  = pd.read_excel(infoFile,
                          sheet_name='early_sham (ES)',index_col=0,header=0)  #DataFrame containing zebrin band file 
