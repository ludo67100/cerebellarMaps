...
UPDATE 06/05/2019 : This version runs with neo 0.8 
...
NAMES = ['200318-A1(1)',
         ...
         '210318-C4(1)',
         '231219-S0(2)','231219-S0(3)',
         '241219-S4(1)','241219-S4(2)',
         '271219-S3(1)',
         '281219-S1(1)','281219-S1(2)']
...
df  = pd.read_excel(measureFile,
                    sheet_name='LS',index_col=0,header=1)  #DataFrame containing zebrin band file 

#Excel sheet with files and parameters : GC-PC_mappings_data_info.xlsx  
filelist  = pd.read_excel(infoFile,
                          sheet_name='late_sham (LS)',index_col=0,header=0)  #DataFrame containing zebrin band file 
