...
NAMES = ['050318-D2(1)','050318-D2(2)','050318-D2(3)',
        ...
        '280218-D4(1)','280218-D4(2)','080318-B1(2)',
        ]

FOLDERS = ['050318-D2(1)','050318-D2(2)','050318-D2(3)',
         '060318-D1(2)',
         '070318-B4(1)','070318-B4(2)',
         '080318-B1(1)','080318-B1(2)',
         '090318-B2(1)',
...
df  = pd.read_excel(measureFile,
                    sheet_name='LC',index_col=0,header=1)  #DataFrame containing zebrin band file 

#Excel sheet with files and parameters : GC-PC_mappings_data_info.xlsx  
filelist  = pd.read_excel(infoFile,
                          sheet_name='late_cuff (LC)',index_col=0,header=0)  #DataFrame containing zebrin band file 
