...
file = 'E:/000_PAPER/FIGURES/Synaptic/LocvsDist/Average_Amplitude_Loc_vs_Dist.xlsx'

saveDir = 'E:/000_PAPER/FIGURES/Synaptic/LocvsDist/Loc vs Loc and Dist vs Dist Average'

sys.stdout = open('{}/Amplitude_LocVSLoc_DistVSDist_Statistics.txt'.format(saveDir),'w')

fig, ax = plt.subplots(1,2,sharex=True,sharey=True)
plt.suptitle('Average Amplitude - Local vs Distal')
...
plt.savefig('{}/Box_Plots.pdf'.format(saveDir))
plt.savefig('{}/Box_Plots.png'.format(saveDir))
