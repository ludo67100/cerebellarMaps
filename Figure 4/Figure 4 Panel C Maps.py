...
This code computes median synaptic patterns and average maps from individual synaptic maps, as well as 2D maps and zscores
...
#Zebrin file
zebrinFile = '{}/Mesures_ZII_HighRes_WT_ENR_EC_LC_ES_LS.xlsx'.format(inputDir)
