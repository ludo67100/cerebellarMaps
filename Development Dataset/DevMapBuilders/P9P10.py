...
datadir = '_Development_Dataset/P9P10'

#Where to save the plots and data
savedir = ''

#Measure and info file from dataset
measureFile = '_/Spaeth_Bahuguna_et_al_GCPC_Mappings_Development_Low_Res_Info.xlsx'
infoFile = '_/Spaeth_Bahuguna_et_al_Measures_Zebrins_Development_LowRes_dataset.xlsx'


DONE = [] #To append names of maps that are done 

NAMES = ['150428(1)','150428(2)','150428(3)',
         '150408(1)',
         '150409(1)','150409(2)',
         '150410(1)','150410(2)','150410(3)',
         '150427(1)','150427(2)']

FOLDERS = ['150428(1)','150428(2)','150428(3)',
         '150408(1)',
         '150409(1)','150409(2)',
         '150410(1)','150410(2)','150410(3)',
         '150427(1)','150427(2)']
...
df  = pd.read_excel(measureFile,
                    sheet_name='P9P10',index_col=0,header=1)  #DataFrame containing zebrin band file 
