...
datadir = '_Development_Dataset/P12P13'
...
NAMES = ['151123(1)',
         '151124(1)',
         '151214(1)','151214(2)','151214(3)',
         '151215(1)','151215(2)','151215(3)',
         '150407(1)',
         '150429(1)','150429(2)','150429(3)']
...
df  = pd.read_excel(measureFile,
                    sheet_name='P12P13',index_col=0,header=1)  #DataFrame containing zebrin band file 
