...
datadir = 'U:/RAW DATA/Development Dataset/P30P40'

#Where to save the data 
savedir = 'E:/000_PAPER/Development/Amplitude_Analysis/00_MAPS/P30P40'
...
df  = pd.read_excel('E:/000_PAPER/Mesures_ZII_LowRes_Adult_and_Dev.xlsx',
                    sheet_name='ADULT',index_col=0,header=1)  #DataFrame containing zebrin band file 
